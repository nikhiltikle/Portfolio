    ...
    <div className='parent pt-16 my-16'>
      <div className=''>
        ...
        <div className='relative grid grid-cols-1 md:grid-cols-2 gap-20'>
          ...
          >
            <h1 className='text-4xl font-semibold mb-4 text-center translate-y-[-320%] sm:translate-y-[-0%] sm:text-3xl sm:mb-2 md:text-left'>
              Nikhil Tikle
            </h1>
            <div className='my-8'>
              <TypeAnimation
            ...
            <p className='text-neutral font-medium text-center translate-y-[-50%] sm:translate-y-[-0%] sm:mb-2 md:text-left' id='about-para'>
            ...
            <br />
            <p className='text-neutral font-medium text-center translate-y-[-150%] sm:translate-y-[-0%] sm:mb-2 md:text-left' id='about-para2'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-4 mt-4 text-center translate-y-[-50%] sm:translate-y-[-0%] sm:mb-2 md:text-left ' id='address'>
