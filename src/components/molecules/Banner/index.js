...
const Banner = () => {
  ...
  return (
    <div className="parent min-h-[80vh] flex flex-col-reverse lg:flex-row items-center justify-between">
      ...
      >
        <h2 className="text-neutral ml-2 text-xl font-medium translate-y-[-30%] sm:translate-y-[-0%]">
          Hello, I'm
        </h2>
        <h1 className="text-4xl ml-2 font-semibold mb-0 translate-y-[-10%] sm:translate-y-[-0%]">
          Nikhil Tikle
        </h1>
        <div className="my-4">
          <TypeAnimation
        ...
        <p className="text-neutral ml-2 max-w-xl mb-6 font-medium translate-y-[-10%] sm:translate-y-[-0%]">
          Front-end developer with 7+ years experience in crafting responsive
          web design. Proficient in Redux, HTML/CSS, ReactJS, NextJS,
          JavaScript, Figma-UI, AdobeXD UI/UX. Specializes in UI/UX-focused web
          development. <br />
          With a proven history of surpassing client expectations and a drive to
